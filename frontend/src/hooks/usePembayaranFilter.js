...
export default function usePembayaranFilter() {
  ...
  useEffect(() => {
    ...
    async function loadData() {
      ...
      try {
        ...
        if (dateFrom) {
          params.append("tanggal_from", dateFrom);
        }

        if (dateTo) {
          params.append("tanggal_to", dateTo);
        }
  ...
  }, [currentPage, searchQuery, statusFilter, dateFrom, dateTo, rumahFilter, refreshTrigger]);
